...
;  * Function, bubbleSort(), sorts the numbers into descending
;    order (large to small).  Uses the bubble sort algorithm (from asst #7).
...
;    Note, function returns quad result in edx:eax
...
extern	bubbleSort, simpleStats, iAverage, variance
